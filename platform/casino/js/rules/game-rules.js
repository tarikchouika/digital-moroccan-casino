    ...
    details: {
      ar: [
        ...
        { h: 'قانون السامبل (104 أوراق)', items: [
          ...
          'الافتتاح: متتالية حرة + متماثلة حرة (خاليتان من الجوكر ومن ورقة مرموق نفس الدور) ومجموع الافتتاح ≥ 51؛ يجوز إدخال ورقة المرموق المسحوبة في مجموعة إضافية صالحة وتُحتسب ضمن الـ51 بشكل قانوني — بشرط ألا تكون جوكراً وألا تكون في المتتالية أو المتماثلة الحرتين الأساسيتين؛ مجموعات الجوكر لا تدخل العتبة لكنها تصلح لتجاوز حساب المفتتح السابق.',
      ...
      fr: [
        ...
        { h: 'Sample (104 cartes)', items: [
          ...
          'Ouverture : suite libre + brelan libre (sans joker ni carte de défausse du même tour), total d\'ouverture ≥ 51 ; la carte de défausse prise peut légalement entrer dans une combinaison supplémentaire valide comptée dans les 51 — à condition qu\'elle ne soit pas un joker et ne figure pas dans les deux combinaisons libres essentielles ; les combinaisons avec joker ne comptent pas dans le seuil mais servent à dépasser le total de l\'ouvreur précédent.',
