    ...
    details: {
      ar: [
        ...
        { h: 'قانون السامبل (104 أوراق)', items: [
          ...
          'الافتتاح: متتالية حرة + متماثلة حرة (خاليتان من الجوكر ومن ورقة مرموق نفس الدور) ومجموع الأوراق الحرة ≥ 51؛ المجموعات التي فيها جوكر أو مرموق نفس الدور ليست حرة لكنها تصلح لتجاوز حساب المفتتح السابق بعد تحقق شروط الافتتاح.',
      ...
      en: [
        ...
        { h: 'Sample Rules (104 Cards)', items: [
          ...
          'Opening: a free Sequence + a free Set (containing no Joker and no same-turn discard-pile card) with free cards totaling ≥ 51; melds containing a Joker or a same-turn discard card are not free, but they do count toward beating the previous opener\'s total once the opening conditions are met.',
      ...
      fr: [
        ...
        { h: 'Sample (104 cartes)', items: [
          ...
          'Ouverture : suite libre + brelan libre (sans joker ni carte de défausse du même tour), total des cartes libres ≥ 51 ; les combinaisons avec joker/défausse ne sont pas libres mais comptent pour dépasser le total de l\'ouvreur précédent, une fois les conditions d\'ouverture remplies.',
      ...
      da: [
        ...
        { h: 'السامبل (104 ورقة)', items: [
          ...
          'الافتتاح: تسلسل حر + متشابهة حرة (بلا جوكر وبلا ورقة مرموق ديال نفس الدور) والمجموع الحر ≥ 51؛ المجموعات لي فيها جوكر ولا مرموق نفس الدور ماشي حرة ولكن كيصلحو باش تفوت حساب المفتتح اللي قبل منك، من بعد ما تحقق شروط الافتتاح.',
