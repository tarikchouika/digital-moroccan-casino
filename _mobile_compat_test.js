...
(async()=>{
  ...
  for (const [label, vp] of [['desktop',{width:1280,height:800}],['mobile',{width:390,height:844,isMobile:true,hasTouch:true}]]) {
    ...
    await A.evaluate(()=>Rooms.createRoom('rm', 10));await wait(A,()=>!!(Rooms.state&&Rooms.state.code));
