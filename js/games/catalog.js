...
const GAMES = [
  ...
  /* [BGDO] الطاولة + الضومنة: مشروعان مستقلان محكومان بعقد المنصة —
     يُدرجان هنا بعد آخر تقليدية (blca)؛ featured صار GAMES[19] (كان 17 قبل الإدراج) */
  {
    id: 'bg',
    eng: 'backgammon',
    em: '🎲',
    ...
    rtp: 96,
    pl: 0,
    n: ['الطاولة', 'Tawla', 'Backgammon', 'الطاولة'],
    d: ['لعبة الجوز والنرد — ضد الحاسوب أو لاعبين', 'Backgammon classique — IA ou 2 joueurs', 'Classic backgammon — vs AI or hot-seat', 'الطاولة ديال الجوز والنرد']
  },
  {
    id: 'do',
    eng: 'dominoes',
    ...
    rtp: 96,
    pl: 0,
    n: ['الضومنة', 'Domino', 'Dominoes', 'الضومنة'],
    d: ['ضومنة القهاوة المغربية — Double-Six', 'Domino marocain — Double-Six', 'Moroccan café dominoes — Double-Six', 'الضومنة ديال القهاوة']
  },
  /* ═══ كراش ═══ */
  {
    id: 'av',
...
const RULES = {
  ...
  /* [BGDO] قواعد الطاولة والضومنة المختصرة — من RULES_DOC داخل كل مشروع (RULES تُعرض عربية فقط) */
  bg: [['انقل أحجارك الخمسة عشر حول الرقعة إلى بيتك ثم أخرِجها كلها قبل خصمك',
      'الافتتاح: كل لاعب يرمي نرداً واحداً — الأعلى يبدأ ويلعب برقمي النردَين معاً',
      'الحركة: كل نرد حركة مستقلة (الدبل = 4 حركات) — لا هبوط على نقطة فيها حجاران للخصم، والحجر المفرد يُضرب إلى الأدمن',
      'الأدمن: لا حركة قبل إدخال كل أحجار الأدمن — والنقطة المغلقة تُضيّع الدور',
      'الإخراج: لا يبدأ إلا بوجود كل الأحجار في البيت — بالرقم المطابق أو الأكبر إن لم توجد أحجار أبعد',
      'يجب استخدام أكبر عدد ممكن من النردات — وإن أمكن واحدة وجب استخدام الأكبر',
      'الحسم: فوز عادي ×1 — مارس ×2 — باك جامون ×3',
      'المباراة: أول من يجمع طول المباراة (1/3/5 نقاط) يفوز — بلا مكعب مضاعفة',
      'الرهان: يُخصم عند البدء ويتضاعف حسب المستوى عند فوز المباراة (×1.5 / ×2 / ×3)']],
  do: [['مجموعة Double-Six من 28 قطعة فريدة — 7 قطع لكل لاعب والـ 14 الباقية «البنك»',
      'يبدأ صاحب أعلى دبل ويلعبها إلزامياً — وإن لم يوجد دبل بدأ صاحب أثقل قطعة بحرة الاختيار',
      'القطعة قانونية إذا طابقت إحدى قيميها أحد طرفي السلسلة المفتوحين — الدبل يوضع عرضياً ولا يفتح طرفاً ثالثاً',
      'السحب: إن لم تكن لديك حركة تسحب من البنك قطعةً قطعة حتى تصل قطعة صالحة ثم تلعبها فوراً (Block: بلا سحب)',
      'بنك فارغ بلا حركة؟ تمرّر الدور — وتمريران متتاليان = انسداد وتنتهي الجولة',
      'الحساب: إفراغ اليد تأخذ مجموع نقاط يد خصمك — والانسداد يفوز صاحب اليد الأخفر بالفرق، والتعادل بلا نقاط',
      'المباراة: أول من يبلغ النقاط المستهدفة (50 / 100 / 150 / 200) يفوز',
      'الرهان: يُخصم عند البدء ويتضاعف حسب المستوى عند الفوز (×1.5 / ×2 / ×3)']],
